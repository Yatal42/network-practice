...
### ✅ שלב 0: התקן Git (אם עשית Clone)

**אם הורדת את הפרויקט דרך GitHub:**

1. גש ל: https://git-scm.com/download/win
2. הורד Git for Windows
3. הרץ את ההתקנה (השאר הכל ברירת מחדל)
4. בדיקה: פתח CMD חדש והקלד:
   ```
   git --version
   ```
   אמור להופיע: git version 2.x.x

**אם העתקת את התיקייה ב-USB/ענן - דלג על זה.**
